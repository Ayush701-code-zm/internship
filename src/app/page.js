...
export default function Home() {
  return (
    <div className="bg-blue-600 min-h-screen">
      ...
      {/* Rest of the content */}
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-[calc(100vh-120px)] p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
